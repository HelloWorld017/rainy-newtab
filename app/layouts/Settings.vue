<template>
	<section class="Settings">
		...
		<div class="Settings__tab">
			<h1>Weather</h1>
			<checkbox :value="weatherEnabled" @change="setWeatherEnabled"> Enabled </checkbox>
			<checkbox :value="weatherIcon" @change="setWeatherIcon"> Icon </checkbox>
			...
			<label class="Settings__text">
				...
				<input
					...
					@change="setWeatherLocationNative"
				/>
			</label>
		...
		<div class="Settings__tab">
			...
			<checkbox :value="searchEnabled" @change="setSearchEnabled"> Enabled </checkbox>
